...
// Container for beepola generated code. + fixes and adaptations
...
.PLAY_NOTE
             ; Read keyboard and Kempston
             LD   E,A
             XOR  A

;	         IN a,($1f) ; we have problems with lots of emulators when reading Kempston
;	         AND $1f
;            LD C,A
             IN   A,($FE)
             CPL
...
; ************************************************************
.DRUM_TYPE_1
             SUB  $74                          ; On entry A=$75+Drum number (i.e. $76 to $7D), this makes it $2 to $9
             LD   B,A
             LD   A,$80
.L822C       RLA                               ;
